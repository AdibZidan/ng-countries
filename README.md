...
![Design preview for the REST Countries API with color theme switcher coding challenge](src/assets/design/desktop/desktop-preview.jpg)
...
Your task is to build out the project to the designs inside the `src/assets/design` folder. 
